...
const CartItems = () => {
  ...
  const handlePayment = async () => {
    ...
    try {
      const res = await axios.post(
        `https://react-pos-backend.vercel.app/api/order`,
        {
          items: cart.length,
      ...
      // }
      const options = {
        key: "rzp_test_cywM3RBmtlTezD", // Enter the Key ID generated from the Dashboard
  ...
  return (
    <div>
            ...
            {cart.length > 0 ? (
              <>
                                ...
                                <div className="sm:flex">
                                  <div className="flex text-xs space-x-3 items-center">
                                    <svg
                                      ...
                                      stroke-width="1.5"
                                      stroke="currentColor"
                                      class="cursor-pointer w-5 h-5 bg-[#1f2544] rounded-sm p-1 "
                                    >
                                      <path
                ...
                <div className="px-4 py-1">
                  <small className="leading-none text-[#494d55]">
                    Note:- Lorem ipsum dolor sit amet consectetur adipisicing
                    elit. Eum aspernatur consectetur aliquid doloribus, at
                    placeat aliquam earum.
                  </small>
                </div>
              </>
            ) : (
            ...
            <div>
              <div className="grid grid-cols-3 gap-0">
                ...
                <div
                  ...
                  className="bg-[#151a34] text-center p-2 text-sm font-semibold hover:bg-[#1f2544] cursor-pointer border border-black rounded-tr-lg"
                >
      ...
      {invoiceShow && (
        <Invoice closeInvoice={closeInvoice} paymentMode={paymentMode} />
      )}
    </div>
  );
};
